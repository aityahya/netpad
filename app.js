...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  if(hasStorage() === true){  //2
    ...
    content.addEventListener("keyup", function() {
      localStorage.setItem("NetPAD-content", this.value);
    });

    title.addEventListener("keyup", function() {
      localStorage.setItem("NetPAD-title", this.value);
    });

    if(localStorage.getItem("NetPAD-title")) {
      title.value = localStorage.getItem("NetPAD-title");
    }

    if(localStorage.getItem("NetPAD-content")) {
      content.value = localStorage.getItem("NetPAD-content");
    }

    if(localStorage.getItem("NetPAD-theme")) {
      var themeClass = localStorage.getItem("NetPAD-theme");
      document.querySelector("html").classList.add(themeClass);
    }

    if(localStorage.getItem("NetPAD-settings")) {
      content.style.cssText = localStorage.getItem("NetPAD-settings");
    }

    if(localStorage.getItem("NetPAD-settings-fs")) {
      fs.value = localStorage.getItem("NetPAD-settings-fs");
    }

    if(localStorage.getItem("NetPAD-settings-lh")) {
      lh.value = localStorage.getItem("NetPAD-settings-lh");
    }

    if(localStorage.getItem("NetPAD-settings-lw")) {
      lw.value = localStorage.getItem("NetPAD-settings-lw");
    }
  ...
  save.addEventListener("click", function(event) {
    ...
    if(title.value == "") {
      ...
      smoke.prompt("Please give your file a title!\n or just keep the default below.", function(e) {
        if(e) {
          title.value = e;
          localStorage.setItem("NetPAD-title", e);
  ...
  clear.addEventListener("click", function(e) {
    if(content.value == "" && title.value == "") {
      ...
      smoke.confirm("This will trash your current text and clear it from NetPAD's localstorage data, are you sure?",function(e) {
        if(e) {
          localStorage.removeItem('NetPAD-title')
          localStorage.removeItem('NetPAD-content');
          title.value = "";
          content.value = "";
  ...
  function textSettings() {
    ...
    // Store settings
    localStorage.setItem("NetPAD-settings", settingValues);
    localStorage.setItem("NetPAD-settings-fs", fsValue);
    localStorage.setItem("NetPAD-settings-lh", lhValue);
    localStorage.setItem("NetPAD-settings-lw", lwValue);
  };
  ...
  theme.addEventListener("click", function() {
    ...
    if(themeClass == "night") {
      localStorage.removeItem("NetPAD-theme");
    } else {
      localStorage.setItem("NetPAD-theme", "night");
    }
  });
  ...
  reset.addEventListener("click", function() {
    localStorage.removeItem("NetPAD-settings");
    localStorage.removeItem("NetPAD-settings-fs");
    localStorage.removeItem("NetPAD-settings-lh");
    localStorage.removeItem("NetPAD-settings-lw");
